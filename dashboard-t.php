...
<?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Testing Dashboard</h1>
...
?>
                        ...
                        <!--Total Booking for Testing-->
                        <div class="col-xl-3 col-md-6 mb-5">
                            <div class="card border-bottom-primary shadow h-100 py-4">
                                <a href="all-test.php">
                                <div class="card-body">
                        ...
                        <!-- Assigned test-->
                        <div class="col-xl-3 col-md-6 mb-5">
                            <div class="card border-bottom-success shadow h-100 py-4">
                                <a href="assigned-test.php">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                              Total Tests Assigned</div>
                        ...
                        <!-- Sample Collected -->
                        <div class="col-xl-3 col-md-6 mb-5">
                            <div class="card border-bottom-warning shadow h-100 py-4">
