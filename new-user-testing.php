...
<head>
    ...
    <title>Covid-19 Vaccination Management System | New User Test Slot Booking</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Covid19-Testing Registration</h1>
  ...
  <div class="row">
                        ...
                        <div class="form-group">
                            <label>Full Name</label>
                                            <input type="text" class="form-control" id="fullname" name="fullname"  placeholder="Enter your Full Name" pattern="[A-Za-z ]+" title="Use letters only." required="true">
                                        </div>
                                        <div class="form-group">
                                             <label>Mobile Number</label>
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Please enter your Mobile Number" pattern="[0-9]{10}" title="10 Numbers only" required="true" onBlur="mobileAvailability()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="govtidnumber" name="govtidnumber" placeholder="Enter your Government Issued ID Number" pattern="[0-9A-Z]{10,12}" title="Enter a Valid ID." required="true">
                                        </div>
                           ...
                           <div class="card shadow mb-4">
                             ...
                             <div class="form-group">
                                            ...
                                            <option value="Sputnik-V">Sputnik-V</option>    
                                                      ...
                                                      <div class="form-group">
                                            <label>Book Slot for Testing</label>
