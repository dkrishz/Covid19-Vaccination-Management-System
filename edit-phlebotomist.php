...
$query="update tblphlebotomist set FullName='$fname',MobileNumber='$mnumber',Password='$Password' where id='$pid'";
...
<head>
    ...
    <title>Covid19 Management System | Edit Phlebotomist</title>
 ...
 <div class="form-group">
                  ...
                  <div class="form-group">
                        ...
                        <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="inputpwd" name="inputpwd" placeholder="Password" value="<?php echo $row['Password'];?>" required="true" >
