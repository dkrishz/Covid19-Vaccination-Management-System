...
$query=mysqli_query($con,"select id from tblphlebotomist where id='$adminid' and   Password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tblphlebotomist set Password='$newpassword' where id='$adminid'");
...
<head>
    ...
    <title>Covid-19 Management System | Change Password</title>
