...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID from tbladmin where  AdminuserName='$uname' && MobileNumber='$contactno' ");
    $ret=mysqli_fetch_array($query);
    if($ret>0){
      $_SESSION['aid']=$ret['ID'];
     echo "<script>alert('Successfully verified');</script>";
     echo "<script>window.location.href='password-recovery - Copy - Copy.php'</script>";
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                            		...
                            		<p>Enter your username and Contact No to Change Password:</p>
                        		</div>
