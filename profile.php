...
<head>
    ...
    <title>Covid19 Management System | Admin Profile</title>
...
<input type="email" class="form-control" name="email" value="<?php  echo $row['Email'];?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required='true'>
</div>
