...
$query="insert into tblvacrecords(PatientMobileNumber,Vaccine Type,VaccineTimeSlot,OrderNumber) values('$mnumber','$vaccinetype','$timeslot','$orderno');";
...
<head>
    ...
    <title>Covid-19 VMS | B/w Dates Report Date Selection</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Between Dates Report Selection</h1>
