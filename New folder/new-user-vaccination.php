...
$query="insert into vacpatients(FullName,MobileNumber,DateOfBirth,GovtIssuedId,GovtIssuedIdNo,FullAddress,State) values('$fname','$mnumber','$dob','$govtid','$govtidnumber','$address','$state');";
$query.="insert into tblvacrecords(PatientMobileNumber,VaccineType,VaccineTimeSlot,OrderNumber) values('$mnumber','$testtype','$timeslot','$orderno');";
$result = mysqli_multi_query($con, $query);
if ($result) {
echo '<script>alert("Your vaccination request submitted successfully. Order number is "+"'.$orderno.'")</script>';
  echo "<script>window.location.href='new-user-vaccination.php'</script>";
} 
else {
  ...
  <div class="row">
                            ...
                            <label>Full Name</label>
                                  ...
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Please enter your mobile number" pattern="[0-9]{10}" title="10 numeric characters only" required="true" onBlur="mobileAvailability()">
                                        ...
                                        <div class="form-group">
                                               ...
                                               <select class="form-control" id="govtissuedid" name="govtissuedid" required="true" onchange="showfield(this.options[this.selectedIndex].value)">
						...
						<div id="div1"></div>                                      
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="govtidnumber" name="govtidnumber" placeholder="Enter Government Issued ID Number" pattern="[0-9A-Z]{10,12}" title="Enter a Valid ID." required="true">
                                        </div>
                           ...
                           <div class="card shadow mb-4">
                             ...
                             <div class="form-group">
                                            ...
                                            <option value="Sputnik-V">Sputnik-V</option>    
                                                      ...
                                                      <div class="form-group">
                                            <label>Book Slot for Vaccination</label>
