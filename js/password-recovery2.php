...
$query=mysqli_query($con,"select ID from tbladmin where  AdminuserName='$username' ");
        
    $ret=mysqli_num_rows($query);
    if($ret>0){
      $query1=mysqli_query($con,"update tbladmin set Password='$newpassword'  where  AdminuserName='$username' ");
       if($query1)
   {
