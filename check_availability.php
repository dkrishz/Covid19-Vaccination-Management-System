...
if(!empty($_POST["mobnumber"])) {
	$mnumber= $_POST["mobnumber"];
		...
		$result =mysqli_query($con,"select id from vacpatients where MobileNumber='$mnumber'");
		$count=mysqli_num_rows($result);
if($count>0)
{
echo "<span style='color:red'> Mobile already exists. Please try with another mobile number or click on this <a href='registered-user-vaccination.php'>Registered Users</span>";
